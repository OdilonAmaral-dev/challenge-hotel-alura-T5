...
import com.alura.hotel.dao.HospedeDao;
...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede(Long idReserva, EntityManager em) {
	...
	public void criaUI() {
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				System.out.println("RegistroHospede - evemto: mouseEntered" );
		...
		btnAtras.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				System.out.println("Vai tornar visivel o ReservasView - evemto: mouseClicked");
		...
		btnsalvar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Hospede hospede = new Hospede(txtNome.getText(), txtSobrenome.getText(),
						Objects.requireNonNull(txtDataN.getDate()),
						Objects.requireNonNull(txtNacionalidade.getSelectedItem()).toString(),
						txtTelefone.getText(),
						idReserva);
				...
				msgbox("Reserva: " + idReserva + " Cadastrada com sucesso");
			}
		});
